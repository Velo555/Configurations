...
#define CONFIG_EXAMPLES_DIR "Creality/CR-10/BigTreeTech SKR Mini E3 3.0" // no example available // changed by Velo555
 ...
 */
#define USE_CONTROLLER_FAN // Changed by Velo555
#if ENABLED(USE_CONTROLLER_FAN)
  #define CONTROLLER_FAN_PIN PC7           // Set a custom pin for the controller fan // Changed by Velo555
  ...
  #define CONTROLLER_FAN_EDITABLE          // Enable M710 configurable settings // Changed by Velo555
 ...
 */
#define E0_AUTO_FAN_PIN PB15 // Changed by Velo555
...
// @section bltouch
   ...
   */
  //#define BLTOUCH_SET_5V_MODE // Changed by Velo555
   ...
   */
  #define BLTOUCH_HS_MODE true // Changed by Velo555
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define PROBE_OFFSET_WIZARD       // Add a Probe Z Offset calibration option to the LCD menu // Changed by Velo555
    ...
    #define PROBE_OFFSET_WIZARD_XY_POS { X_CENTER, Y_CENTER } // Changed by Velo555
  #endif
#endif
  ...
  #define LCD_INFO_MENU // Changed by Velo555
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define LONG_FILENAME_HOST_SUPPORT      // Get the long filename of a file/folder with 'M33 <dosname>' and list long filenames with 'M20 L' // Changed by Velo555
  //#define LONG_FILENAME_WRITE_SUPPORT   // Create / delete files with long filenames via M28, M30, and Binary Transfer Protocol
  //#define M20_TIMESTAMP_SUPPORT         // Include timestamps by adding the 'T' flag to M20 commands

  #define SCROLL_LONG_FILENAMES           // Scroll long filenames in the SD card menu // Changed by Velo555
...
//
  ...
  #if DGUS_UI_IS(FYSETC, MKS, HIPRECY) // Changed by Velo555
    #define DGUS_PRINT_FILENAME           // Display the filename during printing
    #define DGUS_PREHEAT_UI               // Display a preheat screen during heatup

    #if DGUS_UI_IS(FYSETC, MKS) // Changed by Velo555
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_MULTIPLICATOR_Z  1       // (steps or mm) Steps or millimeter distance for each Z babystep // Changed by Velo555
  #define BABYSTEP_MULTIPLICATOR_XY 1       // (steps or mm) Steps or millimeter distance for each XY babystep // Changed by Velo555
  ...
  #if EITHER(BABYSTEP_ZPROBE_OFFSET, BABYSTEP_GLOBAL_Z) // Changed by Velo555
    #if ENABLED(BABYSTEP_ZPROBE_OFFSET) // Changed by Velo555
      //#define BABYSTEP_HOTEND_Z_OFFSET    // For multiple hotends, babystep relative Z offsets
    #endif
    //#define BABYSTEP_GFX_OVERLAY          // Enable graphical overlay on Z-offset editor // Changed by Velo555
  #endif
#endif
 ...
 */
#define LIN_ADVANCE // Changed by Velo555
#if ENABLED(LIN_ADVANCE)
  #if ENABLED(DISTINCT_E_FACTORS)
    #define ADVANCE_K { 0.0 }     // (mm) Compression length per 1mm/s extruder speed, per extruder // Changed by Velo555
  #else
    #define ADVANCE_K 0.0         // (mm) Compression length applying to all extruders // Changed by Velo555
  #endif
  //#define ADVANCE_K_EXTRA       // Add a second linear advance constant, configurable with M900 L.
  //#define LA_DEBUG              // Print debug information to serial during operation. Disable for production use.
  #define EXPERIMENTAL_SCURVE   // Allow S-Curve Acceleration to be used with LA. // Changed by Velo555
 ...
 */
#define EMERGENCY_PARSER // Changed by Velo555
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT       580        // (mA) RMS current. Multiply by 1.414 for peak current. // Changed by Velo555
    #define X_CURRENT_HOME  (X_CURRENT/2)  // (mA) RMS current for sensorless homing // Changed by Velo555
    ...
    #define Y_CURRENT       580 // Changed by Velo555
    #define Y_CURRENT_HOME  (Y_CURRENT/2) // Changed by Velo555
  ...
  //#define SENSORLESS_HOMING // StallGuard capable drivers only
    ...
    #define X_STALL_SENSITIVITY  75 // Changed by Velo555
    #define X2_STALL_SENSITIVITY X_STALL_SENSITIVITY
    #define Y_STALL_SENSITIVITY  75 // Changed by Velo555
    ...
    #define IMPROVE_HOMING_RELIABILITY // Changed by Velo555
  #endif
   ...
   */
  #define SQUARE_WAVE_STEPPING // Changed by Velo555
...
#define DEFAULT_STDDEV_FILAMENT_DIA 0.05    // Typical estimate for cheap filament // Changed by Velo555
//#define DEFAULT_STDDEV_FILAMENT_DIA 0.02  // Typical advertised for higher quality filament // Changed by Velo555
#if ENABLED(FILAMENT_WIDTH_SENSOR)
  #define FILAMENT_SENSOR_EXTRUDER_NUM 0    // Index of the extruder that has the filament sensor. :[0,1,2,3,4]
  #define MEASUREMENT_DELAY_CM        14    // (cm) The distance from the filament sensor to the melting chamber

  #define FILWIDTH_ERROR_MARGIN        1.0  // (mm) If a measurement differs too much from nominal width ignore it // Changed by Velo555
...
/**
 * CNC Drilling Cycle - UNDER DEVELOPMENT // Changed by Velo555
 *
 * Enables G81 to perform a drilling cycle. // Changed by Velo555
 * Currently only supports a single cycle, no G-code chaining. // Changed by Velo555
 */
//#define CNC_DRILLING_CYCLE // Changed by Velo555
 ...
 */
//#define NO_WORKSPACE_OFFSETS // Changed by Velo555
...
#endif
//#define G0_ANGULAR_FEEDRATE 2700 // (°/min) // Changed by Velo555
 ...
 */
   ...
   */
    ...
    // Continue unloading if sensor detects filament after the initial unload move //Changed by Velo555
    //#define MMU_IR_UNLOAD_MOVE //Changed by Velo555
  #else
