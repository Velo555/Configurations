...
#define STRING_CONFIG_H_AUTHOR "(Velo555)" // Who made the changes. // Changed by velo555
...
#define SHOW_BOOTSCREEN // Changed by Velo555

// Show the bitmap in Marlin/_Bootscreen.h on startup.
#define SHOW_CUSTOM_BOOTSCREEN // Changed by Velo555

// Show the bitmap in Marlin/_Statusscreen.h on the status screen.
//#define CUSTOM_STATUS_SCREEN_IMAGE // Changed by Velo555

// @section machine

// Choose the name from boards.h that matches your setup
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_BTT_SKR_MINI_E3_V3_0 // Changed by Velo555
#endif
 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT -1 // Changed by Velo555
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Creality CR-10 tuned for 210C // Changed by Velo555
  #if ENABLED(PID_PARAMS_PER_HOTEND)
    // Specify up to one value per hotend here, according to your setup.
    // If there are fewer values, the last one applies to the remaining hotends.
    #define DEFAULT_Kp_LIST {  29.83,  29.83 } // Changed by Velo555
    #define DEFAULT_Ki_LIST {   3.24,   3.24 } // Changed by Velo555
    #define DEFAULT_Kd_LIST {  68.61,  68.61 } // Changed by Velo555
  #else
    #define DEFAULT_Kp  29.83
    #define DEFAULT_Ki   3.24
    #define DEFAULT_Kd  68.61
	// FIND YOUR OWN: "M303 E0 S210 C15" to run autotune on the hotend at 210 degreesC for 15 cycles. // Changed by Velo555
  #endif
#endif
 ...
 * @section bed temp
 */
#define PIDTEMPBED // Changed by Velo555
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Stock CR-10 Bed Tuned for 60C // Changed by Velo555
  #define DEFAULT_bedKp 123.85 // Changed by Velo555
  #define DEFAULT_bedKi 24.19 // Changed by Velo555
  #define DEFAULT_bedKd 422.74 // Changed by Velo555

  // FIND YOUR OWN: "M303 E-1 S60 C15" to run autotune on the bed at 60 degreesC for 15 cycles. // Changed by Velo555
#endif // PIDTEMPBED
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 139 } // Changed by Velo555 after calibrating esteps w/ dual gear extruder
 ...
 */
#define S_CURVE_ACCELERATION // Changed by Velo555
 ...
 */
//#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN // Changed by Velo555

// Force the use of the probe for Z-axis homing
#define USE_PROBE_FOR_Z_HOMING // Changed by Velo555
 ...
 */
#define Z_MIN_PROBE_PIN PC14 // SKR Mini E3 V3 Z probe is PC14 // Changed by Velo555
 ...
 */
#define BLTOUCH // Changed by Velo555 CR-Touch
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45, -10, 0 } // Changed by Velo555
...
#define Z_MIN_PROBE_REPEATABILITY_TEST // Changed by Velo555
...
#define AUTO_BED_LEVELING_BILINEAR // Changed by Velo555
//#define AUTO_BED_LEVELING_UBL
//#define MESH_BED_LEVELING // Changed by Velo555
 ...
 */
#define RESTORE_LEVELING_AFTER_G28 // Changed by Velo555
//#define ENABLE_LEVELING_AFTER_G28

/**
 * Auto-leveling needs preheating
 */
#define PREHEAT_BEFORE_LEVELING // Changed by Velo555
#if ENABLED(PREHEAT_BEFORE_LEVELING)
  #define LEVELING_NOZZLE_TEMP 185   // (°C) Only applies to E0 at this time // Changed by Velo555
  #define LEVELING_BED_TEMP     60 // Changed by Velo555
#endif
 ...
 */
#define DEBUG_LEVELING_FEATURE // Changed by Velo555
  ...
  #define GRID_MAX_POINTS_X 7 // Changed by Velo555
  ...
  //#define PROBE_Y_FIRST
    ...
    #define EXTRAPOLATE_BEYOND_GRID // Changed by Velo555

    //
    // Experimental Subdivision of the grid by Catmull-Rom method.
    // Synthesizes intermediate points to produce a more detailed mesh.
    //
    #define ABL_BILINEAR_SUBDIVISION // Changed by Velo555
 ...
 */
#define LCD_BED_LEVELING // Changed by Velo555

#if ENABLED(LCD_BED_LEVELING)
  #define MESH_EDIT_Z_STEP  0.025 // (mm) Step size while manually probing Z axis.
  #define LCD_PROBE_Z_RANGE 4     // (mm) Z Range centered on Z_MIN_POS for LCD Z adjustment
  #define MESH_EDIT_MENU        // Add a menu to edit mesh points // Changed by Velo555
#endif
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 50, 50, 50, 50 } // (mm) Left, Front, Right, Back insets // Changed by Velo555
  #define BED_TRAMMING_HEIGHT      0.0        // (mm) Z height of nozzle at leveling points
  #define BED_TRAMMING_Z_HOP       4.0        // (mm) Z height of nozzle between leveling points
  //#define BED_TRAMMING_INCLUDE_CENTER       // Move to the center after the last corner
  #define BED_TRAMMING_USE_PROBE // Changed by Velo555
 ...
 */
#define Z_SAFE_HOMING // Changed by Velo555
...
#define HOMING_FEEDRATE_MM_M { (50*60), (50*60), (4*60) } // Changed by Velo555
...
#define PREHEAT_1_TEMP_BED     60 // Changed by Velo555
#define PREHEAT_1_TEMP_CHAMBER 35
#define PREHEAT_1_FAN_SPEED   255 // Value from 0 to 255 // Changed by Velo555

#define PREHEAT_2_LABEL       "ABS"
#define PREHEAT_2_TEMP_HOTEND 240
#define PREHEAT_2_TEMP_BED    110
#define PREHEAT_2_TEMP_CHAMBER 35
#define PREHEAT_2_FAN_SPEED   255 // Value from 0 to 255 // Changed by Velo555
 ...
 */
#define PRINTCOUNTER // Changed by Velo555
 ...
 */
#define DISPLAY_CHARSET_HD44780 WESTERN // Changed by Velo555
